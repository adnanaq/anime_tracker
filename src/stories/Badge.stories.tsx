...
export const Primary: Story = {
  render: (args) => {
    ...
    return <Badge {...otherArgs} variant="primary">{args.children || "Primary"}</Badge>;
  },
  args: {
    children: "Primary",
  },
  parameters: {
    docs: {
      description: {
        story: "Primary variant badge. Variant is fixed to primary, but you can control size, shape, children, interactive, animated, and other properties.",
      },
    },
  },
};
...
export const Secondary: Story = {
  render: (args) => {
    const { variant, ...otherArgs } = args;
    return <Badge {...otherArgs} variant="secondary">{args.children || "Secondary"}</Badge>;
  },
  args: {
    children: "Secondary",
  },
  parameters: {
    docs: {
      description: {
        story: "Secondary variant badge. Variant is fixed to secondary, but you can control size, shape, children, interactive, animated, and other properties.",
      },
    },
  },
};
...
export const Success: Story = {
  render: (args) => {
    const { variant, ...otherArgs } = args;
    return <Badge {...otherArgs} variant="success">{args.children || "Success"}</Badge>;
  },
  args: {
    children: "Success",
  },
  parameters: {
    docs: {
      description: {
        story: "Success variant badge. Variant is fixed to success, but you can control size, shape, children, interactive, animated, and other properties.",
      },
    },
  },
};
...
export const Warning: Story = {
  render: (args) => {
    const { variant, ...otherArgs } = args;
    return <Badge {...otherArgs} variant="warning">{args.children || "Warning"}</Badge>;
  },
  args: {
    children: "Warning",
  },
  parameters: {
    docs: {
      description: {
        story: "Warning variant badge. Variant is fixed to warning, but you can control size, shape, children, interactive, animated, and other properties.",
      },
    },
  },
};
...
export const Danger: Story = {
  render: (args) => {
    const { variant, ...otherArgs } = args;
    return <Badge {...otherArgs} variant="danger">{args.children || "Danger"}</Badge>;
  },
  args: {
    children: "Danger",
  },
  parameters: {
    docs: {
      description: {
        story: "Danger variant badge. Variant is fixed to danger, but you can control size, shape, children, interactive, animated, and other properties.",
      },
    },
  },
};
...
export const Info: Story = {
  render: (args) => {
    const { variant, ...otherArgs } = args;
    return <Badge {...otherArgs} variant="info">{args.children || "Info"}</Badge>;
  },
  args: {
    children: "Info",
  },
  parameters: {
    docs: {
      description: {
        story: "Info variant badge. Variant is fixed to info, but you can control size, shape, children, interactive, animated, and other properties.",
      },
    },
  },
};
...
export const Neutral: Story = {
  render: (args) => {
    const { variant, ...otherArgs } = args;
    return <Badge {...otherArgs} variant="neutral">{args.children || "Neutral"}</Badge>;
  },
  args: {
    children: "Neutral",
  },
  parameters: {
    docs: {
      description: {
        story: "Neutral variant badge. Variant is fixed to neutral, but you can control size, shape, children, interactive, animated, and other properties.",
      },
    },
  },
};
...
export const Outline: Story = {
  render: (args) => {
    const { variant, ...otherArgs } = args;
    return <Badge {...otherArgs} variant="outline">{args.children || "Outline"}</Badge>;
  },
  args: {
    children: "Outline",
  },
  parameters: {
    docs: {
      description: {
        story: "Outline variant badge. Variant is fixed to outline, but you can control size, shape, children, interactive, animated, and other properties.",
      },
    },
  },
};
